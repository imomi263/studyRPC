...
public class RpcClientAutoConfiguration {
    ...
    public DiscoveryService discoveryService(@Autowired RpcClientProperties properties,@Autowired LoadBalance loadBalance) {
//        return new ZookeeperDiscoveryService(properties.getDiscoveryAddr(), loadBalance);
        return new RedisDiscoveryService(8099,"110.41.139.215","p@ssw0rd",1,loadBalance);
    }
